...
/**
 * Created by Karthi on 9/19/2018.
 */

public class AddNewCropModel implements Serializable {
...
*/
    @SerializedName("cropPledges")
    @Expose
    private List<Object> cropPledges = null;
   ...
   /* public ArrayList<CropPledges> getArrayList_cropPledges() {
    ...
    public List<Object> getCropPledges() {
        return cropPledges;
    }

    public void setCropPledges(List<Object> cropPledges) {
        this.cropPledges = cropPledges;
    }
